  ...
  return (
    <InputHolder ref={ref}>
      ...
      <PhoneInput
        ...
        enableSearch={true}
        localization={language === "pl" ? {pl:"Polska",us:"Stany Zjednoczone",de:"Niemcy",gb:"Wielka Brytania",fr:"Francja",it:"Włochy",es:"Hiszpania",nl:"Holandia",be:"Belgia",at:"Austria",ch:"Szwajcaria",ie:"Irlandia",pt:"Portugalia",cz:"Czechy",sk:"Słowacja",hu:"Węgry",ro:"Rumunia",bg:"Bułgaria",gr:"Grecja",hr:"Chorwacja",si:"Słowenia",lt:"Litwa",lv:"Łotwa",ee:"Estonia",ua:"Ukraina",se:"Szwecja",no:"Norwegia",dk:"Dania",fi:"Finlandia",is:"Islandia"} : undefined}
